...
const translations = {
  en: {
    ...
    ui: {
      ...
      cookiePreferences: "Cookie Preferences", cvTitle: "Curriculum Vitae", cvTimeline: "Career timeline",
  ...
  de: {
    ...
    owner: {
      ...
      racingValue: "Motorboot-Rennsport",
    ...
    ui: {
      ...
      cookiePreferences: "Cookie-Einstellungen", cvTitle: "Lebenslauf", cvTimeline: "Beruflicher Werdegang",
  ...
  hu: {
    ...
    owner: {
      ...
      racingValue: "Motorcsónakversenyzés",
    ...
    ui: {
      ...
      cookiePreferences: "Süti beállítások", cvTitle: "Önéletrajz", cvTimeline: "Szakmai idővonal",
